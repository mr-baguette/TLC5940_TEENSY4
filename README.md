...
2. Adjust `src/TLC5940_config.h` to match your wiring, including XERR/VPRG options, SPI bus selection, and GSCLK frequency (with optional CCM_CLKO output). Set GSCLK to 0 if you supply an external clock.
